...
public class MainActivity extends AppCompatActivity implements SignalingClient.Callback {
    ...
    SurfaceViewRenderer remoteView2;
...
//        // display in localView
        ...
        remoteView2 = findViewById(R.id.remoteView2);
        remoteView2.setMirror(false);
        remoteView2.init(eglBaseContext, null);
    ...
    private void call() {
        ...
        peerConnection = peerConnectionFactory.createPeerConnection(iceServers, new PeerConnectionAdapter("localconnection") {
            ...
            public void onAddStream(MediaStream mediaStream) {
                ...
                runOnUiThread(() -> {
                    remoteVideoTrack.addSink(!isRemoteAdded ? remoteView : remoteView2);
                    isRemoteAdded = true;
                });
            }
        });
